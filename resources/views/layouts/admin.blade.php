...
<head>
  ...
  <style>
    ...
    /** propriedades do ícone de ligado/desligado **/
    ...
    /** se a cor do background não for invertida com o código que inverte tudo, defina aqui que cor você quer que o  background fique quando o theme estiver no modo invertido **/
...
<body class="hold-transition sidebar-mini layout-fixed ">
  ...
  <li class="nav-item dropdown">
    <a class="nav-link" data-toggle="dropdown" href="#">
      ...
      <img src='{{asset("/storage/".$imagem[0])}}' class="direct-chat-img" width="54px" alt="User Image">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <a href="{{asset('/storage/'.$imagem[0])}}" data-toggle="lightbox">
            <img src="{{asset('/storage/'.$imagem[0])}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8; ">
          </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!--
          <li class="nav-item">
            <a href="javascript:;" class="drop nav-link">
              <i class="nav-icon far fa-envelope"></i>
              <p>
                + Acessibilidade
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview ">
              <li>
                <i class="nav-item"></i>
                <a class="nav-link" id="change-colors" href="#" onclick="return false;">Contraste</a>
                <br>
                <a>TAMANHO DA FONTE:</a><br>
                <a class="nav-link" href="javascript:;" id="increase-font">A +</a><br>
                <a class="nav-link" href="javascript:;" id="normal-font">A</a><br>
                <a class="nav-link" href="javascript:;" id="decrease-font">A -</a>
              </li>
            </ul>
          </li>
          -->
  ...
  <div class="content-wrapper">
    ...
    <script src="{{asset('customizados/acessibilidade.js')}}"></script>
