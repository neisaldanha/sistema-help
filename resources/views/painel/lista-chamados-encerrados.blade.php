                            ...
                            <table id="chamados" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach($chamados as $chamado)
                                        <input hidden="" type="text" value=" {{$diferenca = strtotime($chamado->DATA_ENCERRAMENTO) - strtotime($chamado->DATA_ABERTURA)}}">
                                        ...
                                        @endif
                                            ...
                                            <th>{{date('d/m/Y', strtotime($chamado->DATA_ENCERRAMENTO))}}</th>
                                            <td>{{$chamado->USU_LOGIN}}</td>
                                            <td title="@if($dias == 0)Menos de 24hs @else Finalizado com @endif">{{$dias}}</td>
                                            @if($chamado->VIEW == 'S')
	                                                                    ...
	                                                                    <div class="tab-content">
	                                                                     ...
	                                                                     <div class="tab-pane" id="newInter-{{$chamado->ID_CHAMADO}}">
                                                                            <form  method="get" action="{{url('painel/interacao/chamado',$chamado->ID_CHAMADO)}}" enctype="multipart/form-data">
															                    ...
															                    <input hidden="" type="text" name="dpto" value="{{$dptos}}" />
															                    <!--
															                    <div id="imagem" class="col-md-8">
															                      <div class="">
