                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($chamado->STATUS == 'F')
                                        <button type="button" title="Reabrir chamado" class="btn btn-success btn-xs" data-toggle="modal" data-target="#encerrar-{{$chamado->ID_CHAMADO}}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">@if(($chamado->STATUS =='E') || ($chamado->STATUS =='A'))Você deseja ENCERRRA o chamado @else Você deseja REABRIR o chamado @endif <strong> {{$chamado->d_descricao}}</strong> ?</h5>
                                ...
                                <div class="modal fade print_div" id="editar-{{$chamado->ID_CHAMADO}}">
